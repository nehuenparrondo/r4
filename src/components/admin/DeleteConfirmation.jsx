...
export function DeleteConfirmation({ itemName, itemType, onCancel, onConfirm }) {
  ...
  async function confirmDelete() {
    ...
    try {
      ...
      setError(requestError.message || 'No se pudo eliminar el registro.')
      setDeleting(false)
    }
  }

  return (
    <div className="form-overlay" role="presentation" onMouseDown={(event) => event.target === event.currentTarget && !deleting && onCancel()}>
